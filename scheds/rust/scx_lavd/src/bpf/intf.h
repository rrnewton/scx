...
enum {
  ...
  LAVD_CPDOM_MAX_NR = 512, /* maximum number of compute domain */
  /* TEMP_PERCPU_HACK: allowing 1-1 fake compute domains per cpu. */
  LAVD_CPDOM_MAX_DIST =
      3, /* maximum distance from one compute domain to another */

  LAVD_PCO_STATE_MAX =
      11, /* maximum number of performance vs. CPU order states */
